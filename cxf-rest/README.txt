...
curl  -H 'Accept: application/json'  http://localhost:9090/greeter/greeter/greeting/fred

To see the response as XML :

curl  -H 'Accept: text/xml'  http://localhost:9090/greeter/greeter/greeting/fred